...
private["_missionPos","_patrolAreaIndex","_patrolAreaPos","_check","_counter","_equal1","_equal2","_grpPos","_overwatchPos","_mrkPos","_barrier1","_barrier2","_barrier3","_barrier4","_barrel1","_mrkPatrol","_mrk","_gunner","_grp"];
...
if (_counter < 10000) then {
	...
	_gunner = _grp createUnit ["O_Soldier_F", [(_missionPos select 0) + 2.5, (_missionPos select 1)], [], 0, "NONE"];
	...
	// create group
	_overwatchPos = [_missionPos, 250, 100, 20] call BIS_fnc_findOverwatch;
