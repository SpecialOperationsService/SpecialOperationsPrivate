/*
	...
	_this select 1: ARRAY - Array of arrays
		((_this select 1) select n: ARRAY - Array of strings, Classnames of weapons and components
...
for "_i" from 1 to 5 do {_unit addItemToVest (_weapon select 1);};
for "_i" from 1 to 3 do {_unit addItemToVest (_weapon select 3);};
for "_i" from 1 to 3 do {_unit addItemToVest (_weapon select 1);};
_unit addWeapon (_weapon select 0);
_unit addItemToVest (_weapon select 1);
_unit addItemToVest (_weapon select 3);
