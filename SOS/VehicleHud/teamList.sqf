				...
				if(!(format["%1", name _x] == "") and !(format["%1", name _x] == "Error: No unit")) then {
					...
					switch(_x)do {
						case commander _vehicle: {
							_text=_text+format ["<t size='1.35' shadow='2' color='#77c753'>%1</t> <t size='1.5'><img image='SOS\VehicleHud\media\icon_commander.paa'></t><br/>", name _x]; 
						};
						case gunner _vehicle: { 
							_text=_text+format ["<t size='1.35' shadow='2' color='#77c753'>%1</t> <t size='1.5'><img image='SOS\VehicleHud\media\icon_gunner.paa'></t><br/>", name _x]; 
						};
						case driver _vehicle: { 
							_text=_text+format ["<t size='1.35' shadow='2' color='#77c753'>%1</t> <t size='1.5'><img image='SOS\VehicleHud\media\icon_driver.paa'></t><br/>", name _x]; 
						};
						default	{
							if(format["%1", (_role select 0)] != "Turret") then {
								_text=_text+format ["<t size='1.35' shadow='1' color='#567656'>%1</t> <t size='1.5'><img image='SOS\VehicleHud\media\icon_cargo.paa'></t><br/>", name _x];
							} else {
								_text=_text+format ["<t size='1.35' shadow='2' color='#77c753'>%1</t> <t size='1.5'><img image='SOS\VehicleHud\media\icon_gunner.paa'></t><br/>", name _x];
							};
						};
